#Som Andras min programmeringslärare sa, så får man kopiera, den här biten kod.
...
#Grabbing objects
inventory = {}
enemies = {"Orc": 10} #Fiende namn, sen hp på fienden.
sword = 0
flower = 0
...
def option_cave():
  ...
  if choice in answer_A:
   ...
   if "Sword" in inventory and inventory["Sword"] >= enemies["Orc"]:#The code checks to see if the 
